...
END;
$lw_addnodeparticipant$;/*    Gets the SRID of a livewire enabled schema    */
...
END;
$lw_nodesnearnode$;/*    Gets the SRID of a livewire enabled schema    */
...
END;
$lw_tracesource$;/*    Gets the SRID of a livewire enabled schema    */
